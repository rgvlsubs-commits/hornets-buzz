      ...
      <header className="border-b border-slate-800 bg-gradient-to-r from-[#005F6B] to-[#00788C]">
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex items-center gap-4">
            ...
            <a
              href="/methodology"
              className="hidden md:flex items-center gap-2 px-4 py-2 bg-[#F9A01B]/20 hover:bg-[#F9A01B]/30 border border-[#F9A01B]/50 rounded-lg text-[#F9A01B] text-sm font-medium transition-colors"
            >
